...
import hotelPartnerAuthRoutes from "./routes/hotelPartnerAuthRoutes.js";
import hotelPartnerPortalRoutes from "./routes/hotelPartnerPortalRoutes.js";
import restaurantPartnerAuthRoutes from "./routes/restaurantPartnerAuthRoutes.js";
...
import pageBuilderTemplateRoutes from "./routes/pageBuilderTemplateRoutes.js";
...
app.use("/api/page-builder-templates", pageBuilderTemplateRoutes);
...
app.use("/api/hotel-partner-auth", hotelPartnerAuthRoutes);
app.use("/api/hotel-partner", hotelPartnerPortalRoutes);
app.use("/api/restaurant-partner-auth", restaurantPartnerAuthRoutes);
