export const PLATFORM_MENU_ITEMS = [
  ...
  { label: "Hotels", link: "/discover/hotels", itemType: "link", categoryKey: "hotels" },
  { label: "Restaurants", link: "/discover/restaurants", itemType: "link", categoryKey: "restaurants" },
  { label: "Templates", link: "/templates", itemType: "link", categoryKey: "templates" },
